      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              Real feedback from real clients who trust C&C Construction and
              Electrical
            </motion.p>
          </motion.div>
          ...
          <div className="space-y-12">
            {testimonials.map((testimonial, index) => {
              ...
              return (
                ...
                >
                  <motion.div
                    className={`relative p-10 rounded-3xl border-2 backdrop-blur-sm transition-all duration-700 ${accentClasses.border} bg-gradient-to-br from-black/80 via-gray-900/60 to-black/80 hover:shadow-2xl ${accentClasses.shadow}`}
                    whileHover={{
                      y: -12,
                      scale: 1.03,
                    }}
                  ...
                  >
                    ...
                    <div className="absolute top-6 right-6">
                      ...
                      >
                        <IconComponent
                          className={`w-7 h-7 ${accentClasses.icon}`}
                        />
                      </motion.div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 mb-6">
                      {[...Array(testimonial.rating)].map((_, i) => (
                        ...
                        >
                          <Star
                            className={`w-6 h-6 fill-current ${accentClasses.text}`}
                          />
                        </motion.div>
                      ))}
                    </div>
