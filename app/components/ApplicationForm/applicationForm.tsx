      ...
      <div className="max-w-5xl mx-auto bg-black border-2 border-amber-500 rounded-lg shadow-lg p-8">
        <header className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-300">
            Please complete this accurately, giving as many details as possible of your skills and experience relating to this job application. 
            Shortlisting will be based on the information gathered from the form, read in conjunction with the person specification.
          </p>
          <p className="mt-2 text-gray-300">
            Please ensure the finished form is printed out, signed, dated, and returned to one of the members of the office staff. 
            We are unable to accept forms returned as email attachments without a signature.
          </p>
        </header>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Section title="2. EMPLOYMENT RECORD">
            <p className="mb-4 text-gray-300">
              ...
              If you wish to expand on specific areas of responsibility, please do so in Section 5: Experience/skills.
            </p>
              ...
              <div key={index} className="mb-8 p-4 border border-gray-700 rounded">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <TextField 
                    ...
                    onChange={(e) => handleEmploymentChange(index, 'employer', e.target.value)}
                  />
                  <TextArea 
                    label="Address" 
                    name={`address-${index}`}
                  ...
                  <div className="md:col-span-2">
                    <TextArea 
                      ...
                      name={`duties-${index}`}
                      value={record.duties} 
                      onChange={(e) => handleEmploymentChange(index, 'duties', e.target.value)}
                    />
                  </div>
                  <div className="md:col-span-2">
                    <TextField 
                    ...
                    <tr key={index} className="border-b border-gray-700">
                      ...
                      <td className="p-2 border border-gray-700">
                        <input
                          ...
                          onChange={(e) => handleEducationChange(index, 'dateGained', e.target.value)}
                          className="w-full p-1 bg-black text-white border-none focus:ring-1 focus:ring-amber-500"
                        />
                      </td>
                    </tr>
                    ...
                    <tr key={index} className="border-b border-gray-700">
                      <td className="p-2 border border-gray-700">
                        <input
                          type="text"
                          value={record.course}
                          onChange={(e) => handleTrainingChange(index, 'course', e.target.value)}
                          className="w-full p-1 bg-black text-white border-none focus:ring-1 focus:ring-amber-500"
                        />
                      </td>
                      <td className="p-2 border border-gray-700">
          ...
          <Section title="5. EXPERIENCE / SKILLS">
            ...
            <p className="mb-4 text-gray-300">
              After reading the Job Description and Person Specification carefully, consider to what extent you have gained the skills and 
              experience necessary for the post. Your experience need not have been gained in paid employment and may include special 
              interests relevant to the post. It is important that you provide evidence of your achievements by giving examples to support your application. 
              You may wish to use the headings in the person specification in order to set the information out clearly.
            </p>
            <TextArea 
          ...
          <Section title="6. REFERENCES">
            <p className="mb-4 text-gray-300">
              Please give name, address and position/occupation of two referees. One must be your present or most recent employer. 
              References will only be taken up for the successful candidate. Testimonials or references from friends and relatives are not acceptable.
            </p>
          ...
          <Section title="8. DECLARATION AND SIGNATURE">
            ...
            <p className="mt-6 text-xs text-gray-400">
              By signing and returning this application form you consent to using and keeping information about you provided by you us – or
              third parties such as referees – relating to your application or future employment. This information will be used solely in the
              recruitment process and will be retained for six months from the date on which you are informed whether you have been invited to
              interview, or six months from the date of interview. Such information may include details relating to ethnic monitoring and disability:
              these will be used solely for internal monitoring and will not be disclosed to any third party. Thank you for completing the form.
            </p>
          </Section>
