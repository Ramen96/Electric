...
export default function Contact() {
  ...
  const handleChange = (e) => {
    ...
    if (id === "phone") {
      ...
      setFormState((prev) => ({ ...prev, [id]: formattedPhone }));
    } else {
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="p-6 bg-black/60 backdrop-blur-lg border border-yellow-500/20 rounded-xl shadow-lg mb-8">
              ...
              <div className="space-y-6">
                {contactOptions.map((option, index) => (
                  <motion.a
                    ...
                    whileHover={{ x: 5 }}
                  >
                    <div className="flex items-center justify-center w-12 h-12 rounded-full bg-yellow-500/10 text-yellow-400 mr-4">
                      {option.icon}
                    </div>
                    <div>
