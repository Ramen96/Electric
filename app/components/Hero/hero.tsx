...
//             <span className="block mt-2 text-lg text-blue-200 font-light">
    ...
    <section id="hero" className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-between text-gray-100 p-8">
        ...
        >
          ...
          <motion.div variants={textVariants} custom={0} className="mb-6">
            <motion.div
              className="h-16 w-16 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center"
              animate={{
                boxShadow: [
